...
public class EventStartsNotificationWorker extends EventNotificationWorker {

    public EventStartsNotificationWorker(@NonNull Context context,
    ...
    public Result doWork() {
        ...
        String title = context.getResources()
                .getString(R.string.event_started_title, event.getTitle());
